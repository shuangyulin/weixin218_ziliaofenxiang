  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='积分' prop="yonghuJifenNumber">
                 <el-input v-model="ruleForm.yonghuJifenNumber"  placeholder='积分' disabled ></el-input>
             </el-form-item>
         </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yonghuJifenNumber)&& 'yonghu'==this.flag){
