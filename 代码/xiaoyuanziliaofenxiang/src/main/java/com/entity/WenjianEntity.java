...
public class WenjianEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Wenjian{" +
            ...
            ", wenjianPhoto=" + wenjianPhoto +
            ", wenjianFile=" + wenjianFile +
            ", wenjianJifenNumber=" + wenjianJifenNumber +
            ", zanNumber=" + zanNumber +
            ", caiNumber=" + caiNumber +
            ", yonghuId=" + yonghuId +
            ", wenjianStatusTypes=" + wenjianStatusTypes +
            ", biaoshiStatusTypes=" + biaoshiStatusTypes +
            ", wenjianContent=" + wenjianContent +
